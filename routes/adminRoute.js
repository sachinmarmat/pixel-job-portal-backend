...
const { deleteUser, deleteEmployer, deleteJob, suspendUser, reactivateUser, reactivateEmployer, suspendEmployer, getjobseeker, getemploye, getAllJobs, getAdmin, getCompanyDetails} = require('../controllers/adminController');
...
//-----------get Employers-----------------
router.get("/getemploye",protect, allowRoles('admin','employ','jobseeker'), getemploye);
